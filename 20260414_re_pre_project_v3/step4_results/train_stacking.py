#!/usr/bin/env python3
"""
Model 7/15: Stacking (CPU)
Protocol v3.0 - Stacked ensemble of base models
"""
import os
...
with open("model_07_stacking.json", "w") as f:
    json.dump(results, f, indent=2)

np.save("model_07_stacking_oof.npy", oof_predictions)
np.save("model_07_stacking_holdout.npy", holdout_pred)
