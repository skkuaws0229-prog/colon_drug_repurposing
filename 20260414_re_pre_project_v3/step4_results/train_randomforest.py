...
print("="*80)
print("Model 5/15: RandomForest (CPU)")
print("="*80)
...
with open("model_05_randomforest.json", "w") as f:
    json.dump(results, f, indent=2)

np.save("model_05_randomforest_oof.npy", oof_predictions)
np.save("model_05_randomforest_holdout.npy", holdout_pred)
