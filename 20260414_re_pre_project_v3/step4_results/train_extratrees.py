...
print("="*80)
print("Model 6/15: ExtraTrees (CPU)")
print("="*80)
...
for fold_idx, (tr_idx, val_idx) in enumerate(kf.split(X_cv), 1):
    ...
    # ExtraTrees with reduced estimators (v1: Sp=0.6468 FAIL)
...
with open("model_06_extratrees.json", "w") as f:
    json.dump(results, f, indent=2)

np.save("model_06_extratrees_oof.npy", oof_predictions)
np.save("model_06_extratrees_holdout.npy", holdout_pred)
